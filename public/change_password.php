...
<head>
    ...
    <title>Change Password | Whisper</title>
        ...
        <?php else: ?>
            ...
            <form action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="password" id="repeat_new_password" name="repeat_new_password" class="form-control" required>
                </div>

                <button type="submit" class="btn btn-form-register">Change Password</button>
            </form>
        <?php endif; ?>
    </div>
</section>
